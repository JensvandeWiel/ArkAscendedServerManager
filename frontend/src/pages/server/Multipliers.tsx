		...
		<div className={'space-y-4'}>
			<div className={'space-x-4 w-full'}>
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Allow increasing or decreasing global item stack size, this means all default stack sizes will be multiplied by the value given (excluding items that have a stack size of 1 by default).'}>
				...
				<div className={''}>
					<Tooltip
						enterDelay={500}
						title={
							'Specifies the scaling factor for the experience received by players, tribes and dinosaurs for various actions. The default value 1 provides the same amounts of experience as in the single player experience (and official public servers). Higher values increase XP amounts awarded for various actions; lower values decrease it.'
						}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the map base temperature scaling factor: lower value makes the environment colder, higher value makes the environment hotter.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the speed of crop decay in plots. A higher value decrease (by percentage) speed of crop decay in plots.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the speed of crop growth in plots. A higher value increases (by percentage) speed of crop growth.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the effectiveness of custom recipes. A higher value increases (by percentage) their effectiveness.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the effect of the players crafting speed level that is used as a base for the formula in creating a custom recipe. A higher number increases (by percentage) the effect.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Sets the quality of items that have a quality when fishing. Valid values are from 1.0 to 5.0.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Defines the interval of fuel consumption.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the amount of XP earned for generic XP (automatic over time).'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the decomposition time of corpses, (player and dinosaur), globally. Higher values prolong the time.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the decomposition time of dropped items, loot bags etc. globally. Higher values prolong the time.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the spoiling time of perishables globally. Higher values prolong the time.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'If bIncreasePvPRespawnInterval is True, scales the PvP additional re-spawn time (IncreasePvPRespawnIntervalBaseAmount) when a player is killed by a team within a certain amount of time (IncreasePvPRespawnIntervalCheckPeriod).'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scale the amount of XP earned for a kill.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scale the amount of XP earned for SpecialEvent.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Increases the quality of items that have a quality in the supply crates. Valid values are from 1.0 to 5.0. The quality also depends on the Difficulty Offset.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Modifies corpse and dropped box lifespan.'}>
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for structures decay times, e.g.: setting it at 2.0 will double all structure decay times, while setting at 0.5 will halve the timers. Note: despite the name, works in both PvP and PvE modes when structure decay is enabled.'}>
		...
		<div className={'space-y-4'}>
			<div className={'space-x-4'}>
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={"Specifies the scaling factor for dinosaurs' food consumption. Higher values increase food consumption (dinosaurs get hungry faster). It also affects the taming-times."}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for dinosaur spawns. Higher values increase the number of dinosaurs spawned throughout the ARK.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={
							'Specifies the scaling factor for the resistance to damage wild dinosaurs receive when attacked. The default value 1 provides normal damage. Higher values decrease resistance, increasing damage per attack. Lower values increase it, reducing damage per attack. A value of 0.5 results in a creature taking half damage while a value of 2.0 would result in a creature taking double normal damage.'
						}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Affects how quickly the food drains on such "Raid Dinos" (e.g.: Titanosaurus)\t'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for the damage tamed creatures deal with their attacks. The default value 1 provides normal damage. Higher values increase damage. Lower values decrease it.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={
							'Specifies the scaling factor for the resistance to damage tamed creatures receive when attacked. The default value 1 provides normal damage. Higher values decrease resistance, increasing damage per attack. Lower values increase it, reducing damage per attack. A value of 0.5 results in a structure taking half damage while a value of 2.0 would result in a structure taking double normal damage.'
						}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for dinosaur taming speed. Higher values make taming faster.\t'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how long after delaying cuddling with the Baby before Imprinting Quality starts to decrease.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={"Scales how often babies needs attention for imprinting. More often means you'll need to cuddle with them more frequently to gain Imprinting Quality. Scales according to BabyMatureSpeedMultiplier: if both set at 1.0 the imprint request is every 8 hours. "}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={"Scales how fast Imprinting Quality decreases after the grace period if you haven't yet cuddled with the Baby."}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the speed that baby dinos eat their food. A lower value decreases (by percentage) the food eaten by babies.\n'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how much of an effect on stats the Imprinting Quality has. Set it to 0 to effectively disable the system.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the maturation speed of babies. A higher number decreases (by percentage) time needed for baby dino to mature. See Times for Breeding tables for values at 1.0'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the damage done to a harvestable item/entity by a Dino. A higher number increases (by percentage) the speed of harvesting.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the damage done by Turrets towards a Dino. A higher values increases it (by percentage).'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the time needed for a fertilised egg to hatch. A higher value decreases (by percentage) that time.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the time between eggs are spawning / being laid. Higher number increases it (by percentage).'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the interval between dinos can mate. A lower value decreases it (on a percentage scale). Example: a value of 0.5 would allow dinosaurs to mate 50% sooner.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the speed at which dinos mate with each other. A higher value increases it (by percentage). Example: MatingSpeedMultiplier=2.0 would cause dinosaurs to complete mating in half the normal time.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how often a survivor get tame requests for passive tame dinos.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how fast tame dinos consume food.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how fast tamed dinos lose torpor.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how fast wild dinos consume food.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how fast wild dinos lose torpor.'}>
		...
		<div className={'space-y-4'}>
			<div className={'space-x-4 w-full'}>
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for yields from all harvesting activities (chopping down trees, picking berries, carving carcasses, mining rocks, etc.). Higher values increase the amount of materials harvested with each strike.'}>
				...
				<div className={''}>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for the re-spawn rate for resource nodes (trees, rocks, bushes, etc.). Lower values cause nodes to re-spawn more frequently.\t'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the amount of XP earned for harvesting.'}>
		...
		<div className={'space-y-4'}>
			<div className={'space-x-4 w-full'}>
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Use this to set how swim speed is multiplied by level spent in oxygen.'}>
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={"Specifies the scaling factor for player characters' food consumption. Higher values increase food consumption (player characters get hungry faster).\t"}>
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={"Specifies the scaling factor for player characters' health recovery. Higher values increase the recovery rate (player characters heal faster).\t"}>
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={"Specifies the scaling factor for player characters' stamina consumption. Higher values increase stamina consumption (player characters get tired faster).\t"}>
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={"Specifies the scaling factor for player characters' water consumption. Higher values increase water consumption (player characters get thirsty faster)."}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for the damage players deal with their attacks. The default value 1 provides normal damage. Higher values increase damage. Lower values decrease it.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the bonus received from upgrading the Crafting Skill.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the amount of XP earned for crafting.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the hair growth. Higher values increase speed of growth.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales the damage done to a harvestable item/entity by a Player. A higher value increases it (by percentage): the higher number, the faster the survivors collects.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Scales how frequently survivors can poop. Higher value decreases it (by percentage)'}>
		...
		<div className={'space-y-4'}>
			<div className={'space-x-4 w-full'}>
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Higher value increases (from a percentage scale) max number of items place-able on saddles and rafts.'}>
						<FormLabel>Per Platform Max Structures Multiplier</FormLabel>
					</Tooltip>
					<Slider
						sliderStep={0.1}
				...
				<div className={'ml-4'}>
					<Tooltip
						enterDelay={500}
						title={'Increasing the number allows structures being placed further away from the platform.'}>
				...
				<div className={''}>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for the damage structures deal with their attacks (i.e., spiked walls). Higher values increase damage. Lower values decrease it.\t'}>
				...
				<div className={''}>
					<Tooltip
						enterDelay={500}
						title={'Same as ResourceNoReplenishRadiusStructures in Game.ini. If both settings are set both multiplier will be applied. Can be useful when cannot change the Game.ini file as it works as a command line option too.'}>
				...
				<div>
					<Tooltip
						enterDelay={500}
						title={'Specifies the scaling factor for damage structures take within caves. The lower the value, the less damage the structure takes (i.e. setting to 1.0 will make structure built in or near a cave receive the same amount of damage as those built on the surface).'}>
		...
		<>
			<Card variant='soft'>
				<AccordionGroup variant='soft'>
					...
					<Accordion>
						<AccordionSummary>
							<Typography level='title-md'>Dino Multipliers</Typography>
						</AccordionSummary>
						<AccordionDetails>
							<br />{' '}
							<DinoMultipliers
					...
					<Accordion>
						<AccordionSummary>
							<Typography level='title-md'>Harvesting Multipliers</Typography>
						</AccordionSummary>
						<AccordionDetails>
							<br />{' '}
							<HarvestingMultipliers
								setServ={setServ}
								serv={serv}
							/>
						</AccordionDetails>
					...
					<Accordion>
						<AccordionSummary>
							<Typography level='title-md'>Player Multipliers</Typography>
						</AccordionSummary>
						<AccordionDetails>
							<br />{' '}
							<PlayerMultipliers
					...
					<Accordion>
						<AccordionSummary>
							<Typography level='title-md'>Structure/building Multipliers</Typography>
						</AccordionSummary>
						<AccordionDetails>
							<br />{' '}
