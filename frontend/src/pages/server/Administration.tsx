        ...
        <div className={"inline-block"}>
          ...
          >
            <ModalDialog variant="outlined" role="alertdialog">
              ...
              <Divider />
              <DialogContent>
                Are you sure you want to delete the server files? You cannot
                reverse this action!
              </DialogContent>
              <DialogActions>
                <Button
                  variant="solid"
                  color="danger"
                  onClick={() => onDeleteServerFilesButtonClicked()}
                >
                  Delete Server Files
                </Button>
                <Button
                  variant="plain"
                  color="neutral"
                  onClick={() => setDeleteServerFilesModalOpen(false)}
                >
                  Cancel
                </Button>
              </DialogActions>
        ...
        <div className={"inline-block"}>
          ...
          >
            <ModalDialog variant="outlined" role="alertdialog">
              ...
              <Divider />
              <DialogContent>
                Are you sure you want to delete the profile? You cannot reverse
                this action!
              </DialogContent>
              <DialogActions>
                <Button
                  variant="solid"
                  color="danger"
                  onClick={() => onDeleteProfileButtonClicked()}
                >
                  Delete Profile
                </Button>
                <Button
        ...
        <div className={"inline-block"}>
          ...
          >
            <ModalDialog variant="outlined" role="alertdialog">
              ...
              <Divider />
              <DialogContent>
                Are you sure you want to delete everything? You cannot reverse
                this action!
              </DialogContent>
              <DialogActions>
                <Button
                  variant="solid"
                  color="danger"
                  onClick={() => onDeleteEverythingButtonClicked()}
                >
                  Delete Everything
                </Button>
                <Button
                  variant="plain"
                  color="neutral"
                  onClick={() => setDeleteEverythingModalOpen(false)}
                >
                  Cancel
                </Button>
              </DialogActions>
    ...
    <Card variant="soft" className={""}>
            ...
            <div className={"inline-block"}>
              ...
              >
                <ModalDialog variant="outlined" role="dialog">
                  ...
                  <Divider />
                  <DialogContent>{serverCommand}</DialogContent>
                  <DialogActions>
                    <Button
                      variant="solid"
                      color="neutral"
      ...
      <div className={"space-x-4 w-full flex"}>
        <div className={"inline-block"}>
          ...
          ></Input>
          <FormLabel>
            Custom server "questionmark" arguments (only use args like:
  ...
  return (
    <Card variant="soft" className={""}>
      ...
      <div>
        ...
        />
        <Button className={"m-2"} onClick={() => onSaveConfigButtonClicked()}>
          Save config
        </Button>
      </div>
    </Card>
